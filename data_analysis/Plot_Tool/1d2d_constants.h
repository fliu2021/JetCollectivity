...
const double R=0.8 ;//jet size,theta_g=(R_g/R)
const int beta_bin=3;
const double beta_SD[beta_bin]={0.0,1.0,2.0}; 



//cut mode=1:cut on Zg
const int sdZg_bin= 2;
double sdZg_low[sdZg_bin]={0.0,0.2};
double sdZg_high[sdZg_bin]={0.2,0.5};


//cut mode=2:cut on Rg
const int sdRg_bin=3;
double sdRg_low[sdRg_bin] ={0.0,0.4,0.0 };
double sdRg_high[sdRg_bin]={0.4,1.0,1.0};


//cut mode=3:cut on Zg(Rg/R)^{beta}=Zg(Theta_g)^{beta}, (here ,Theta_g is defined as :Theta_g=Rg/R and R=0.8 as above )
const int sdZgTgB_bin=3;
double sdZgTgB_low[sdZgTgB_bin]={0.00,0.10,0.00};
double sdZgTgB_high[sdZgTgB_bin]={0.10,1.00,1.00};
